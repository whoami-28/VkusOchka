    ...
    public static class DbInitializer
    {
        public static void Initialize(AppDbContext context)
        {
            ...
            var dishes = new Dish[]
            {
                ...
                new Dish { RestaurantId = restaurants[3].Id, Name = "Боул с лососем", Description = "Киноа, лосось, авокадо, бобы эдамаме, чука", Price = 15.00m, IsRecommended = true, Image = "https://images.unsplash.com/photo-1498579150354-979478841054?w=600&h=400&fit=crop", Calories = 460, Protein = 24, Carbs = 45, Fat = 22 },
                ...
                new Dish { RestaurantId = restaurants[5].Id, Name = "Хинкали классические", Description = "Сочные хинкали с говядиной и свининой (5 шт)", Price = 8.00m, IsRecommended = true, Image = "https://images.unsplash.com/photo-1627308595229-7830b5c91f9f?w=600&h=400&fit=crop", Calories = 650, Protein = 30, Carbs = 75, Fat = 24 },
                new Dish { RestaurantId = restaurants[5].Id, Name = "Хачапури по-аджарски", Description = "Лодочка из теста с сыром сулугуни и яйцом", Price = 9.50m, IsRecommended = false, Image = "https://images.unsplash.com/photo-1619597379201-92be0f5a7707?w=600&h=400&fit=crop", Calories = 850, Protein = 35, Carbs = 80, Fat = 45 },
                ...
                new Dish { RestaurantId = restaurants[7].Id, Name = "Том Ям", Description = "Острый тайский суп с морепродуктами", Price = 14.50m, IsRecommended = false, Image = "https://images.unsplash.com/photo-1548943487-a2e4e43b4859?w=600&h=400&fit=crop", Calories = 320, Protein = 24, Carbs = 18, Fat = 16 },
                ...
                new Dish { RestaurantId = restaurants[8].Id, Name = "Свиные ребрышки BBQ", Description = "Томленые ребра в фирменном соусе барбекю", Price = 19.50m, IsRecommended = false, Image = "https://images.unsplash.com/photo-1544025162-8111149f5038?w=600&h=400&fit=crop", Calories = 920, Protein = 45, Carbs = 35, Fat = 62 },
                new Dish { RestaurantId = restaurants[8].Id, Name = "Брискет", Description = "Копченая говяжья грудинка 12 часов томления", Price = 22.00m, IsRecommended = false, Image = "https://images.unsplash.com/photo-1596622527585-61ce4ce2f559?w=600&h=400&fit=crop", Calories = 850, Protein = 55, Carbs = 5, Fat = 68 },
