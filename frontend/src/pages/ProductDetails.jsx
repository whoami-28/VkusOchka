...
export default function ProductDetails() {
  const productData = {
    ...
    rating: "4.9",
    reviews: "128",
    description: "Питательный микс запеченного батата, капусты кейл, киноа и пряного нута под лимонно-кунжутным соусом с обжаренными тыквенными семечками. Идеальный полезный обед.",
