      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex gap-6">
            <Link to="/browse" className="text-orange-600 border-b-2 border-orange-600 font-semibold pb-1 px-3 py-2 text-label-md">Browse</Link>
            <Link to="/profile/history" className="text-stone-600 hover:text-stone-900 transition-all px-3 py-2 text-label-md">Orders</Link>
            <Link to="/offers" className="text-stone-600 hover:text-stone-900 transition-all px-3 py-2 text-label-md">Offers</Link>
            <Link to="/profile/favorites" className="text-stone-600 hover:text-stone-900 transition-all px-3 py-2 text-label-md">Favorites</Link>
          </nav>
        </div>
